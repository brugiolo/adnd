...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // comleted (4) call insertFakeData from TestUtil and pass the database reference mDb
    ...
    private Cursor getAllGuests(){
        ...
        return mDb.query(WaitlistContract.WaitlistEntry.TABLE_NAME, null, null,
                null, null, null, WaitlistContract.WaitlistEntry.COLUMN_TIMESTAMP);
    }
}