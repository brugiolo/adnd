...
public class MainActivity extends AppCompatActivity implements
    ...
    public void showCharging(boolean charging){
        Drawable drawable = charging
                ? getResources().getDrawable(R.drawable.ic_power_pink_80px)
                : getResources().getDrawable(R.drawable.ic_power_grey_80px);

        mChargingImageView.setImageDrawable(drawable);
    }
    ...
    public class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean charging = action == Intent.ACTION_POWER_CONNECTED;
