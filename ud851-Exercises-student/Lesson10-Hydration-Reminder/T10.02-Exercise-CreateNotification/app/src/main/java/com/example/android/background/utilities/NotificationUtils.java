...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1325;
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 1325;
    ...
    private static PendingIntent contentIntent(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,
                WATER_REMINDER_PENDING_INTENT_ID, mainActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
