...
public class ReminderUtilities {
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
        // completde (17) If the job has already been initialized, return
        // completde (18) Create a new GooglePlayDriver
        // completde (19) Create a new FirebaseJobDispatcher with the driver
        // completde (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // completde (21) Use dispatcher's schedule method to schedule the job
        // completde (22) Set sInitialized to true to mark that we're done setting up the job
}
