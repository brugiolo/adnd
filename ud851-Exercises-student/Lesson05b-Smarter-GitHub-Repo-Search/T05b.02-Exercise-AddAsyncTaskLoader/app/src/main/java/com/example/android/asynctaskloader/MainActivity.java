...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery == null || githubQuery.equals("")){
            mUrlDisplayTextView.setText("Please, enter a data to search...");
            return;
        }
        ...
        android.support.v4.content.Loader<Object> githubLoaderManager = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
