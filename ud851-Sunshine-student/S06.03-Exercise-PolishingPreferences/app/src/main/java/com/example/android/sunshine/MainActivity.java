...
public class MainActivity extends AppCompatActivity implements
    ...
    // refresh (7) In onStart, if preferences have been changed, refresh the data and set the flag to false
    @Override
    protected void onStart() {
        super.onStart();

        if (this.PREFERENCE_UPDATED){
            invalidateData();
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, this);
            this.PREFERENCE_UPDATED = false;
        }
    }
