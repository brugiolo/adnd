...
public class SunshineSyncUtils {
    ...
    private static final int syncMinutes = 180;
    private static final int syncSeconds = (int) TimeUnit.MINUTES.toSeconds(syncMinutes);

    private static boolean sInitialized;

    private static final String syncTag = "syncTagSunshine";

//  TODO (12) Create a method to schedule our periodic weather sync
    private static void syncScheduler(@NonNull final Context context){
