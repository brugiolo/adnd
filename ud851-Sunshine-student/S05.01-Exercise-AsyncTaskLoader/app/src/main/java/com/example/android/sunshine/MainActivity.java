...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks {
    ...
    private void loadWeatherData() {
        ...
        Loader<String> fetchWeatherLoader = loaderManager.getLoader(FETCH_WEATHER_LOADER);
        if (fetchWeatherLoader == null) {
            loaderManager.initLoader(FETCH_WEATHER_LOADER, null, this);
        } else {
            loaderManager.restartLoader(FETCH_WEATHER_LOADER, null, this);
        }
