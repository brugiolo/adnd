...
//  completed (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    private TextView mHighTempDisplay;
    private TextView mLowTempDisplay;
...
//      completed (13) Find each of the TextViews by ID
        ...
        mDescriptionDisplay = (TextView) findViewById(R.id.tv_description);
        mHighTempDisplay = (TextView) findViewById(R.id.tv_high_temperature);
        mLowTempDisplay = (TextView) findViewById(R.id.tv_low_temperature);
